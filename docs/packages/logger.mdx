---
title: "@factory/logger"
description: Structured JSON logger for Cloudflare Workers.
---

# @factory/logger

Structured JSON logger with levels, context binding, and child loggers. Depends on `@factory/errors` and `@factory/monitoring`.

## Installation

```bash
npm install @factory/logger
```
