---
title: "@factory/stripe"
description: Stripe webhook handling and subscription lifecycle management.
---

# @factory/stripe

Stripe webhook verification and subscription event routing for Cloudflare Workers. Depends on `@factory/errors` and `@factory/logger`.

## Installation

```bash
npm install @factory/stripe
```
...
```typescript
import { verifyWebhook, handleSubscriptionEvent } from '@factory/stripe';
