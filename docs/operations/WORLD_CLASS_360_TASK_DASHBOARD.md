...
| W360-032 | Template buildout pack | D13 + discipline leads | `docs/templates/`, `packages/deploy/templates/`, `packages/testing`, `packages/studio-core` | W360-031 | ⚡ IN PROGRESS — Template inventory complete: 22 templates catalogued (10 ready-to-reference, 12 pending creation); Phase 1 priorities (worker-basic, ADR, OpenAPI); `docs/W360_032_TEMPLATE_PACK.md` provides scaffolding guidance |
...
| W360-034 | Config normalization pass | D09, D12, D10 | `wrangler.jsonc`, GitHub Actions, `package.json`, lockfiles, TS/ESLint/Vitest, Renovate, Sentry/PostHog, service registry | W360-031 | ⚡ IN PROGRESS — Audit complete: 18 gaps identified across wrangler/package.json/GHActions/TS/Sentry; `docs/CONFIG_NORMALIZATION_AUDIT.md` created with 3-phase playbook; Priority-1 templates ready (wrangler.jsonc, package.json standards); Phase 1 execution (app-by-app sync) beginning |
