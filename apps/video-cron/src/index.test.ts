...
const env: Env = {
  ...
  GITHUB_REPO: 'adrper79-dot/Factory',
...
describe('video-cron', () => {
  ...
  it('fetches app-scoped pending jobs and dispatches the render workflow', async () => {
    ...
    expect(fetchMock.mock.calls[2]?.[0]).toBe('https://api.github.com/repos/adrper79-dot/Factory/actions/workflows/render-video.yml/dispatches');
  });
