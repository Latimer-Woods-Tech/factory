...
test.describe('UI Regression Gates — Homepage', () => {
  ...
  test('detects visual regression (desktop)', async ({ page }) => {
    await page.goto('/');
    const screenshots = await captureScreenshots(page, 'homepage-latest', ACTUAL_SCREENSHOTS_DIR);
  ...
  test('detects visual regression (mobile)', async ({ page }) => {
    await page.goto('/');
    const screenshots = await captureScreenshots(page, 'homepage-mobile', ACTUAL_SCREENSHOTS_DIR);
...
test.describe('UI Regression Gates — Pricing Page', () => {
  test('detects visual regression', async ({ page }) => {
    ...
    const screenshots = await captureScreenshots(page, 'pricing', ACTUAL_SCREENSHOTS_DIR);
...
test.describe('UI Regression Gates — Practitioners Page', () => {
  test('detects visual regression', async ({ page }) => {
    ...
    const screenshots = await captureScreenshots(page, 'practitioners', ACTUAL_SCREENSHOTS_DIR);
